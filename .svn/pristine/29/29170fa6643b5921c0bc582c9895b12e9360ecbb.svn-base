	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		...
		<div class="row cl" id="etime">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  placeholder="请输入产品类型" id="productTypeName" name="productTypeName" style="width:500px;">
			</div>
		</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				<input class="btn btn-danger radius" type="button" value="&nbsp;&nbsp;确定添加&nbsp;&nbsp;" onclick="addType()">
			</div>
		</div>
...
function addType(){
	if($("#productTypeName").val()==""){layer.alert("请输入产品类型！"); return;} 
