...
public class CaptchaUtil {
	...
	private final static String IMAGE_CHAR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";

	private final static Integer IMAGE_WIDTH = 120;
	private final static Integer IMAGE_HEIGHT = 40;
	 ...
	 *            随机数序号
	 */
	private static void drawString(Graphics graphics, int i) {
	 ...
	 * @return 背景色
	 */
	private static Color createRandomColor(int fc, int bc) {// 给定范围获得随机颜色
		// 随机对象
		Random random = new Random();
		// 随机初始数值不得大于255
		if (fc > 255)
	...
	private static void saveCodeInSession(HttpServletRequest request) {
