...
<article class="page-container">
	...
	<table class="table ">
				...
				<tr class="text-c">
					<td rowspan="3" width="150">
						...
						<div class="formControls">
							<div id="localImag">
								...
								<img id="preview" width="150" height="180" src="${pro.productImage}"/>
							</div>
					...
					<td colspan="2">
					<input type="text" name="productName" id="productName" value="${pro.productName }" class="input-text"/>
				...
				<tr>
					<td colspan="4">
						<div  class="formControls">
							<input type="text" class="input-text"  style="width:300px;" placeholder="请输入产品价格(例：5.6)" id="productMoney" name="productMoney" value="${pro.productMoney }">
				...
				<tr>
					<td colspan="4">
						<div  class="formControls">
							<textarea id="productIntro" name="productIntro" cols="" rows="" class="textarea"  placeholder="说点什么..." datatype="*0-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${pro.productIntro }</textarea>
				...
				<tr class="text-r">
					<td colspan="4">
									<button onClick="editProduct()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 提交</button>
...
<script type="text/javascript">
$(function(){
	$("#productTypeId option[value='"+ ${pro.productTypeId} +"']").attr("selected","selected");
});
...
function editProduct(){
	...
	$.ajax({
	  ...
	  success: function(data) {
		  if(data==1){
			  layer.confirm("修改产品成功！",{btn:['返回产品列表','继续修改']},function(index){
	       		 	layer_close();
           });
		  }else{
			  layer.alert("修改失败！");
