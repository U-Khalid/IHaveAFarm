	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		...
		<div class="row cl" id="etime">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  value="${type.productTypeName} " id="productTypeName" name="productTypeName" style="width:500px;">
			</div>
		</div>`
...
function editUser(){
	...
	$.ajax({
	  ...
	  success: function(data) {
		  if(data==1){
			  layer.confirm("修改成功！",{btn:['返回产品类型列表']},function(index){
	       		 	layer_close();
           });
		  }else{
			  layer.alert("修改失败！");
